      ...
      <div className="bg-transparent w-full">
        <div className="px-2 py-1">
          ...
          {isChatOpen && (
            ...
            <div className="flex-1 overflow-y-auto mb-3 p-3 rounded-lg bg-white/10 backdrop-blur-md max-h-64 min-h-[120px] glass-content shadow-lg">
            ...
            >
              <input
                ref={chatInputRef}
                className="flex-1 rounded-lg px-3 py-2 bg-white/5 backdrop-blur-md text-gray-800 placeholder-gray-500 text-xs focus:outline-none focus:ring-1 focus:ring-gray-400/60 shadow-lg transition-all duration-200"
              ...
              <button
                type="submit"
                className="p-2 rounded-lg bg-white/5 hover:bg-gray-700/80 flex items-center justify-center transition-all duration-200 backdrop-blur-sm shadow-lg disabled:opacity-50"
